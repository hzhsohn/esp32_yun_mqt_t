...
{	
	...
	{
		char *pstrparam=Cmdline+strlen(command)+1;
		cmd_open_wifi(pstrparam);
	}
	else if(0==strcmp("connectwifi",command))
	{
		char *pstrparam=Cmdline+strlen(command)+1;
		cmd_connect_wifi(pstrparam);
	}
	...
	{
		char *pstrparam=Cmdline+strlen(command)+1;
		cmd_setuart1(pstrparam);
	}
	else if(0==strcmp("setuart2",command))
	{
		char *pstrparam=Cmdline+strlen(command)+1;
		cmd_setuart2(pstrparam);
	}
	...
	{
		char *pstrparam=Cmdline+strlen(command)+1;
		cmd_setmqtt(pstrparam);
	}
	else if(0==strcmp("setmqttinfo",command))
	{
		char *pstrparam=Cmdline+strlen(command)+1;
		cmd_setmqttinfo(pstrparam);
	}
